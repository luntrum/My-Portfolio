...
function MyHomeSection() {
  return (
    <main className="main-section">
      <section
        id="home"
        className="    flex  flex-col-reverse items-center justify-center gap-8 p-6 md:flex-row  scroll-mt-40 widescreen:section-min-height tallscreen:screen:section-min-height md:mb-80"
      >
